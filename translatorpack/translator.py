...
def chin_trans(char): #translation app 
...
def unaccent(word): #removes accents from a word
...
def num_maker(wrd): #converts accent into relative numerical tone
...
def apply_num(wrds): #finds numerical tones
